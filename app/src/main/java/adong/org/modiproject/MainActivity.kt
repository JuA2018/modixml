...
import adong.org.modiproject.Adapter.MyListAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var diarylist : ListView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listAdapter = MyListAdapter(applicationContext, listarraydata)
        diarylist.adapter = listAdapter
